...
(function (SceptaDesign) {
    SceptaDesign.OrganizationController = SceptaDesign._module.controller("SceptaDesign.OrganizationController", ['$scope', '$routeParams', '$http', function ($scope, $routeParams, $http) {
        ...
        $scope.addPolicyGroup = function () {
            $http.post('/scepta-server/design/' + $scope.organizationName + '/group', $scope.newPolicyGroup).success(function (data, status, headers, config) {
                $http.get('/scepta-server/design/' + $scope.organizationName + '/group').success(function (data) {
                    $scope.policygroups = data;
        ...
        $scope.removePolicyGroup = function (event) {
            ...
            if (c == true) {
                ...
                $http.delete('/scepta-server/design/' + $scope.organizationName + '/group/' + policyGroupName).success(function (data, status, headers, config) {
                    $http.get('/scepta-server/design/' + $scope.organizationName + '/group').success(function (data) {
                        $scope.policygroups = data;
                    });
                });
...
(function (SceptaDesign) {
    SceptaDesign.OrganizationsController = SceptaDesign._module.controller("SceptaDesign.OrganizationsController", ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.addOrganization = function () {
            $http.post('/scepta-server/design/', $scope.newOrganization).success(function (data, status, headers, config) {
                $http.get('/scepta-server/design').success(function (data) {
                    $scope.organizations = data;
        ...
        $scope.removeOrganization = function (event) {
            ...
            if (c == true) {
                ...
                $http.delete('/scepta-server/design/' + orgName).success(function (data, status, headers, config) {
                    $http.get('/scepta-server/design').success(function (data) {
                        $scope.organizations = data;
                    });
                });
...
var SceptaDesign;
(function (SceptaDesign) {
    SceptaDesign.PGProcessorController = SceptaDesign._module.controller("SceptaDesign.PGProcessorController", ['$scope', '$routeParams', '$http', function ($scope, $routeParams, $http) {
        $scope.organizationName = $routeParams.organization;
        $scope.policyGroupName = $routeParams.policygroup;
...
var SceptaDesign;
(function (SceptaDesign) {
    SceptaDesign.PLProcessorController = SceptaDesign._module.controller("SceptaDesign.PLProcessorController", ['$scope', '$routeParams', '$http', function ($scope, $routeParams, $http) {
        $scope.organizationName = $routeParams.organization;
        $scope.policyGroupName = $routeParams.policygroup;
...
var SceptaDesign;
(function (SceptaDesign) {
    SceptaDesign.ResourceController = SceptaDesign._module.controller("SceptaDesign.ResourceController", ['$scope', '$routeParams', '$http', function ($scope, $routeParams, $http) {
        $scope.organizationName = $routeParams.organization;
        $scope.policyGroupName = $routeParams.policygroup;
        $scope.policyName = $routeParams.policy;
